...
# ---------------------------------------
# 🗺️ Folium Map - Radio Toggle via BaseLayers
# ---------------------------------------
...
# Define FeatureGroups as base layers (exclusive)
...
fg_30.add_child(create_layer(gdf_afr1, '30_day_utilization', '30-Day Utilization'))
fg_60.add_child(create_layer(gdf_afr1, '60_day_utilization', '60-Day Utilization'))
fg_90.add_child(create_layer(gdf_afr1, '90_day_utilization', '90-Day Utilization'))

map_afr1.add_child(fg_30)  # default visible
map_afr1.add_child(fg_60)
map_afr1.add_child(fg_90)

# Add layer control with radio toggle
